...
| **055** | Refactor | Medium | Approved | parser.js からトークナイザー、パーサー、意味解析器、評価器、および AST ノードへのクラス・ファイル分離 | [055-separate-parser-evaluator-and-nodes.md](055-separate-parser-evaluator-and-nodes.md) |
