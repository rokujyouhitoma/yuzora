...
| **057** | Refactor | Medium | Draft | Parser からの HTML 組み立て処理の完全排除と Evaluator への責務集約 | [057-parser-evaluator-responsibility-separation.md](057-parser-evaluator-responsibility-separation.md) |
