...
| **146** | Bug | High | Closed | CI/CD E2E TOCテスト — `#page-nav-left` オーバーレイによる `#reader-viewport` クリック遮断の修正 | AI Agent | [146-fix-ci-toc-page-nav-overlay-intercept.md](closed/146-fix-ci-toc-page-nav-overlay-intercept.md) |
