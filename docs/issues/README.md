...
| **016** | Feature | Medium | In Progress | 画面・機能ごとの開発用ファイル分割と最終生成物のバンドル統合化 | AI Agent | [016-modularize-src-by-screen-and-bundle.md](016-modularize-src-by-screen-and-bundle.md) |
