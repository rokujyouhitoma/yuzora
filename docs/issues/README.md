...
| **143** | Bug | High | New | CI/CD E2Eテスト TOCドロワーテスト中の `#reader-viewport` クリックでヘッダーの `hidden` クラスが解除されない | AI Agent | [143-fix-ci-toc-header-hidden-after-jump.md](143-fix-ci-toc-header-hidden-after-jump.md) |
