...
| **040** | Feature | Medium | In Progress | AssetクラスとResourceDirectorの導入によるリソース管理の抽象化 | AI Agent | [040-introduce-asset-and-resource-director.md](040-introduce-asset-and-resource-director.md) |
