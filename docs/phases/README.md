...
各フェーズは [MNG-02 開発プロセスおよび成果物定義書](../MNG-02-development_process.md) で定義された 9 つの工程に対応します。
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **PHASE-01** | 要求定義 | User Requirements Definition (URD) | — | [REQ-01](../REQ-01-user_requirements.md), [REQ-02](../REQ-02-feature_list.md) | — |
| **PHASE-02** | 要件定義 | System Requirements Definition (SRD) | — | [REQ-03](../REQ-03-system_requirements.md) | — |
| **PHASE-03** | 基本設計 | High-Level Design (HLD) | — | [DSN-01](../DSN-01-high_level_design.md) | — |
| **PHASE-04** | 詳細設計 | Low-Level Design (LLD) | — | [DSN-02](../DSN-02-low_level_design.md) | — |
| **PHASE-05** | 実装 | Implementation (Make) | — | [index.html](../../index.html), [app.js](../../src/js/app.js) | — |
| **PHASE-06** | 単体検証 | Unit Verification | — | [MNG-05](../MNG-05-test_cases.md) Section 4 | — |
| **PHASE-07** | 結合検証 | Integration Verification | — | [MNG-05](../MNG-05-test_cases.md) Section 3 | — |
| **PHASE-08** | システム検証 | System Verification | — | [MNG-05](../MNG-05-test_cases.md) Section 2 | — |
| **PHASE-09** | 受入検証・リリース | Acceptance Verification & Release | — | [MNG-05](../MNG-05-test_cases.md) Section 1 | — |
