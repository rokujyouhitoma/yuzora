...
トレードオフを伴う技術選定やアーキテクチャの変更を行う際は、その背景と結論を ADR（Architecture Decision Record）として明文化し、技術的負債のブラックボックス化を防ぎます。具体的な起票基準やライフサイクル管理については、[MNG-08-adr_process.md](MNG-08-adr_process.md) に従って統制します。
