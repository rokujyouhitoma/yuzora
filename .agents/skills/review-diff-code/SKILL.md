...
3. **Verify 7 Distinct Angles**:
   ...
   - **Security**: Verify input validation, output escaping, absence of secrets/credentials, and conformity to secure web development practices.
   - **Performance**: Look out for memory leaks, redundant computations, heavy DOM manipulations, or slow DB queries.
   - **Design & Requirements Alignment**: Cross-check with high-level and low-level design specifications in `docs/`.
