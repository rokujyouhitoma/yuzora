...
1. **Investigate Codebase**:
   ...
   - **If the issue introduces any architectural changes, UI modifications, or logic tweaks, identify which design documents ([DSN-01](file:///workspace/yuzora/yuzora/docs/DSN-01-high_level_design.md) or [DSN-02](file:///workspace/yuzora/yuzora/docs/DSN-02-low_level_design.md)) must be updated BEFORE making any code changes.**
...
3. **Establish Implementation Plan**:
   ...
   - **Explicitly plan the modifications to the design documents ([DSN-01](file:///workspace/yuzora/yuzora/docs/DSN-01-high_level_design.md) or [DSN-02](file:///workspace/yuzora/yuzora/docs/DSN-02-low_level_design.md)) if requirements or implementation logic deviates from the existing specification.**
...
4. **Define Success Criteria (DoD)**:
   ...
   - **Always include a verification item: "The implementation is fully consistent with [DSN-01](file:///workspace/yuzora/yuzora/docs/DSN-01-high_level_design.md) and [DSN-02](file:///workspace/yuzora/yuzora/docs/DSN-02-low_level_design.md) design specs (no dead documents)."**
